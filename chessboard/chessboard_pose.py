...
img01 = cv2.imread('data/image01.png')
img02 = cv2.imread('data/image02.png')

arr01 = np.load('data/corners01.npy')
arr02 = np.load('data/corners02.npy')
...
cv2.drawFrameAxes(img02, camera_matrix, distCoeffs=None, rvec=rvec, tvec=tvec, length=3)
